...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        # 에디스는 메인 페이지에 접속해서 빈 하이템을 실수로 등록하려고 한다.
        ...
        self.browser.find_element(By.ID, 'id_new_item').send_keys('우유 사기\n')
        ...
        # 아이템을 입력하면 정상 동작한다
        self.browser.find_element(By.ID, 'id_new_item').send_keys('tea 만들기\n')
        self.check_for_row_in_list_table('1: 우유 사기')
